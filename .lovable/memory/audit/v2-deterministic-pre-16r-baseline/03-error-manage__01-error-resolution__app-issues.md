...
> Deterministic score 73/100 (C) for spec/03-error-manage/01-error-resolution/app-issues.


**Score justification:** Deterministic rubric: contracts=1/3, ac=7, gwt=6, broken_links=1, waffle/kchar=0.07. Gates active: 1.
