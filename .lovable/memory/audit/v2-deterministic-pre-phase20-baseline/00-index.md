...
**Mean weighted score:** **77.8/100**  
**Mean implementability:** **52.6/100**
...
| 6 | [`02-coding-guidelines`](./02-coding-guidelines.md) | 90 | A | 10 | _none_ |
| 7 | [`02-coding-guidelines/01-cross-language`](./02-coding-guidelines__01-cross-language.md) | 94 | A | 10 | 1 broken cross-spec link(s) |
...
| 12 | [`17-consolidated-guidelines`](./17-consolidated-guidelines.md) | 79 | B | 7 | 3 broken cross-spec link(s) |
| 13 | [`04-database-conventions`](./04-database-conventions.md) | 89 | A | 7 | _none_ |
| 14 | [`14-update`](./14-update.md) | 88 | A | 6 | _none_ |
| 15 | [`06-seedable-config-architecture/02-features`](./06-seedable-config-architecture__02-features.md) | 82 | B | 5 | _none_ |
...
| 6 | [`03-error-manage/03-error-code-registry/07-schemas`](./03-error-manage__03-error-code-registry__07-schemas.md) | 67 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 7 | [`03-error-manage/03-error-code-registry/08-linter-scripts`](./03-error-manage__03-error-code-registry__08-linter-scripts.md) | 67 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 8 | [`02-coding-guidelines/09-powershell-integration`](./02-coding-guidelines__09-powershell-integration.md) | 68 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 9 | [`02-coding-guidelines/10-research`](./02-coding-guidelines__10-research.md) | 68 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 10 | [`02-coding-guidelines/22-app-issues`](./02-coding-guidelines__22-app-issues.md) | 68 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 11 | [`25-app-issues/01-phase-2-git-logs-audit`](./25-app-issues__01-phase-2-git-logs-audit.md) | 68 | 30 | C | 1 TODO/TBD/FIXME marker(s) in module body |
| 12 | [`02-coding-guidelines/21-app`](./02-coding-guidelines__21-app.md) | 69 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
...
| 15 | [`23-app-database`](./23-app-database.md) | 71 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |

## Top 10 (gold standards)
| Rank | Module | Overall | Impl | Grade |
|---:|---|---:|---:|:-:|
| 1 | [`06-seedable-config-architecture`](./06-seedable-config-architecture.md) | 95 | 85 | A+ |
| 2 | [`18-wp-plugin-how-to`](./18-wp-plugin-how-to.md) | 95 | 95 | A+ |
| 3 | [`02-coding-guidelines/01-cross-language`](./02-coding-guidelines__01-cross-language.md) | 94 | 95 | A |
| 4 | [`05-split-db-architecture`](./05-split-db-architecture.md) | 91 | 75 | A |
| 5 | [`02-coding-guidelines`](./02-coding-guidelines.md) | 90 | 70 | A |
| 6 | [`02-coding-guidelines/06-cicd-integration`](./02-coding-guidelines__06-cicd-integration.md) | 89 | 75 | A |
| 7 | [`04-database-conventions`](./04-database-conventions.md) | 89 | 85 | A |
| 8 | [`14-update/24-update-check-mechanism`](./14-update__24-update-check-mechanism.md) | 89 | 75 | A |
...
| [`03-error-manage/03-error-code-registry/07-schemas`](./03-error-manage__03-error-code-registry__07-schemas.md) | 30 | 60 | 100 | 100 | 100 | 96 | 100 | **67** | C | 0 |
...
| [`03-error-manage/02-error-architecture/06-apperror-package`](./03-error-manage__02-error-architecture__06-apperror-package.md) | 30 | 90 | 100 | 100 | 100 | 100 | 100 | **74** | C | 2 |
...
| [`03-error-manage/02-error-architecture/05-response-envelope`](./03-error-manage__02-error-architecture__05-response-envelope.md) | 55 | 75 | 100 | 100 | 100 | 100 | 100 | **79** | B | 2 |
| [`17-consolidated-guidelines`](./17-consolidated-guidelines.md) | 95 | 55 | 60 | 70 | 100 | 90 | 90 | **79** | B | 7 |
...
| [`14-update/24-update-check-mechanism`](./14-update__24-update-check-mechanism.md) | 75 | 90 | 100 | 100 | 100 | 100 | 100 | **89** | A | 5 |
| [`02-coding-guidelines`](./02-coding-guidelines.md) | 70 | 100 | 100 | 100 | 100 | 100 | 100 | **90** | A | 10 |
