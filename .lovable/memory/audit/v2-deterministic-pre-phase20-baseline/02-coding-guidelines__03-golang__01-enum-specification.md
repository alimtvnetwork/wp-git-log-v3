...
> Deterministic score 73/100 (C) for spec/02-coding-guidelines/03-golang/01-enum-specification.
...
- **Evidence:** code_blocks_by_lang={"bash": 3, "go": 55, "markdown": 1, "plain": 11}
