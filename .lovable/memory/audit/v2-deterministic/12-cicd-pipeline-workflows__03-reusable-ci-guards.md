...
> Deterministic score 82/100 (B) for spec/12-cicd-pipeline-workflows/03-reusable-ci-guards.


**Score justification:** Deterministic rubric: contracts=1/3, ac=5, gwt=5, broken_links=0, waffle/kchar=0.12. Gates active: 0.
