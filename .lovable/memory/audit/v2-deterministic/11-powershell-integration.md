...
> Deterministic score 82/100 (B) for spec/11-powershell-integration.


**Score justification:** Deterministic rubric: contracts=1/3, ac=5, gwt=5, broken_links=0, waffle/kchar=0.09. Gates active: 0.
