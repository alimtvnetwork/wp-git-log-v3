...
> Deterministic score 81/100 (B) for spec/28-universal-ci-cli.


**Score justification:** Deterministic rubric: contracts=1/3, ac=40, gwt=40, broken_links=0, waffle/kchar=0.15. Gates active: 0.
