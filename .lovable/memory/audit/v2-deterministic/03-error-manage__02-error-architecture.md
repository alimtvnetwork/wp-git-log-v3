...
> Deterministic score 80/100 (B) for spec/03-error-manage/02-error-architecture.


**Score justification:** Deterministic rubric: contracts=2/3, ac=5, gwt=5, broken_links=1, waffle/kchar=0.11. Gates active: 1.
