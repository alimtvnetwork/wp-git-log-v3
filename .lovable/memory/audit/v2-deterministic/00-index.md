...
|---:|---|---:|:-:|:-:|---|
| 1 | [`27-spec-toolchain`](./27-spec-toolchain.md) | 73 | C | 0 | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |

## Bottom 15 (lowest implementability)
| Rank | Module | Overall | Impl | Grade | Top finding |
|---:|---|---:|---:|:-:|---|
| 1 | [`27-spec-toolchain`](./27-spec-toolchain.md) | 73 | 40 | C | 6 TODO/TBD/FIXME marker(s) in module body |

## Top 10 (gold standards)
| Rank | Module | Overall | Impl | Grade |
|---:|---|---:|---:|:-:|
| 1 | [`27-spec-toolchain`](./27-spec-toolchain.md) | 73 | 40 | C |
