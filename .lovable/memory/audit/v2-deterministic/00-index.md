...
**Mean weighted score:** **88.9/100**  
**Mean implementability:** **82.8/100**
...
| 6 | [`03-error-manage`](./03-error-manage.md) | 96 | A+ | 10 | _none_ |
| 7 | [`03-error-manage/02-error-architecture/04-error-modal`](./03-error-manage__02-error-architecture__04-error-modal.md) | 96 | A+ | 10 | _none_ |
| 8 | [`06-seedable-config-architecture`](./06-seedable-config-architecture.md) | 96 | A+ | 10 | _none_ |
...
| 11 | [`05-split-db-architecture`](./05-split-db-architecture.md) | 96 | A+ | 9 | _none_ |
| 12 | [`18-wp-plugin-how-to`](./18-wp-plugin-how-to.md) | 96 | A+ | 9 | _none_ |
| 13 | [`02-coding-guidelines/03-golang`](./02-coding-guidelines__03-golang.md) | 96 | A+ | 8 | _none_ |
...
|---:|---|---:|---:|:-:|---|
| 1 | [`02-coding-guidelines/10-research/01-research-index`](./02-coding-guidelines__10-research__01-research-index.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 2 | [`02-coding-guidelines/21-app/01-app-coding-rules`](./02-coding-guidelines__21-app__01-app-coding-rules.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 3 | [`02-coding-guidelines/22-app-issues/01-app-issue-templates`](./02-coding-guidelines__22-app-issues__01-app-issue-templates.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 4 | [`02-coding-guidelines/23-app-database/01-app-database-conventions`](./02-coding-guidelines__23-app-database__01-app-database-conventions.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 5 | [`02-coding-guidelines/24-app-design-system-and-ui/01-app-ui-conventions`](./02-coding-guidelines__24-app-design-system-and-ui__01-app-ui-conventions.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 6 | [`10-research/01-research-index`](./10-research__01-research-index.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 7 | [`14-update/diagrams/01-diagram-conventions`](./14-update__diagrams__01-diagram-conventions.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
| 8 | [`26-gitlogs-diagrams/01-diagram-conventions`](./26-gitlogs-diagrams__01-diagram-conventions.md) | 57 | 30 | D | No inlined contract (SQL DDL / JSON schema / TS enum / OpenAPI / typed-language  |
...
| 3 | [`02-coding-guidelines/03-golang`](./02-coding-guidelines__03-golang.md) | 96 | 90 | A+ |
| 4 | [`02-coding-guidelines/04-php`](./02-coding-guidelines__04-php.md) | 96 | 90 | A+ |
| 5 | [`03-error-manage`](./03-error-manage.md) | 96 | 90 | A+ |
| 6 | [`03-error-manage/02-error-architecture/04-error-modal`](./03-error-manage__02-error-architecture__04-error-modal.md) | 96 | 90 | A+ |
| 7 | [`03-error-manage/02-error-architecture/06-apperror-package`](./03-error-manage__02-error-architecture__06-apperror-package.md) | 96 | 90 | A+ |
| 8 | [`05-split-db-architecture`](./05-split-db-architecture.md) | 96 | 90 | A+ |
| 9 | [`06-seedable-config-architecture`](./06-seedable-config-architecture.md) | 96 | 90 | A+ |
| 10 | [`14-update`](./14-update.md) | 96 | 90 | A+ |

## Full ranking
| Module | Impl | Comp | Align | Cons | Clar | Test | Maint | **Overall** | Grade | Blast |
|---|---:|---:|---:|---:|---:|---:|---:|---:|:-:|:-:|
| [`02-coding-guidelines/10-research/01-research-index`](./02-coding-guidelines__10-research__01-research-index.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`02-coding-guidelines/21-app/01-app-coding-rules`](./02-coding-guidelines__21-app__01-app-coding-rules.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`02-coding-guidelines/22-app-issues/01-app-issue-templates`](./02-coding-guidelines__22-app-issues__01-app-issue-templates.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`02-coding-guidelines/23-app-database/01-app-database-conventions`](./02-coding-guidelines__23-app-database__01-app-database-conventions.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`02-coding-guidelines/24-app-design-system-and-ui/01-app-ui-conventions`](./02-coding-guidelines__24-app-design-system-and-ui__01-app-ui-conventions.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`10-research/01-research-index`](./10-research__01-research-index.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`14-update/diagrams/01-diagram-conventions`](./14-update__diagrams__01-diagram-conventions.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
| [`26-gitlogs-diagrams/01-diagram-conventions`](./26-gitlogs-diagrams__01-diagram-conventions.md) | 30 | 40 | 100 | 100 | 100 | 10 | 100 | **57** | D | 0 |
...
| [`02-coding-guidelines/10-research`](./02-coding-guidelines__10-research.md) | 80 | 75 | 100 | 100 | 100 | 80 | 100 | **87** | A | 2 |
| [`02-coding-guidelines/22-app-issues`](./02-coding-guidelines__22-app-issues.md) | 80 | 75 | 100 | 100 | 100 | 80 | 100 | **87** | A | 2 |
| [`02-coding-guidelines/21-app`](./02-coding-guidelines__21-app.md) | 80 | 80 | 100 | 100 | 100 | 80 | 100 | **88** | A | 2 |
...
| [`02-coding-guidelines/03-golang/04-golang-standards-reference`](./02-coding-guidelines__03-golang__04-golang-standards-reference.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`02-coding-guidelines/04-php/07-php-standards-reference`](./02-coding-guidelines__04-php__07-php-standards-reference.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
...
| [`02-coding-guidelines/07-csharp`](./02-coding-guidelines__07-csharp.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
...
| [`03-error-manage/01-error-resolution/03-retrospectives`](./03-error-manage__01-error-resolution__03-retrospectives.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`03-error-manage/01-error-resolution/05-debugging-guides`](./03-error-manage__01-error-resolution__05-debugging-guides.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
...
| [`03-error-manage/02-error-architecture/04-error-modal/03-error-modal-reference`](./03-error-manage__02-error-architecture__04-error-modal__03-error-modal-reference.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
...
| [`03-error-manage/02-error-architecture/07-logging-and-diagnostics`](./03-error-manage__02-error-architecture__07-logging-and-diagnostics.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`03-error-manage/03-error-code-registry/09-templates`](./03-error-manage__03-error-code-registry__09-templates.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`07-design-system`](./07-design-system.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`13-generic-cli`](./13-generic-cli.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 5 |
| [`14-update/24-update-check-mechanism`](./14-update__24-update-check-mechanism.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 7 |
...
| [`23-app-database`](./23-app-database.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 7 |
| [`24-app-design-system-and-ui`](./24-app-design-system-and-ui.md) | 90 | 90 | 100 | 100 | 100 | 100 | 100 | **94** | A | 4 |
| [`02-coding-guidelines/03-golang`](./02-coding-guidelines__03-golang.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 8 |
| [`02-coding-guidelines/04-php`](./02-coding-guidelines__04-php.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 6 |
| [`03-error-manage`](./03-error-manage.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 10 |
| [`03-error-manage/02-error-architecture/04-error-modal`](./03-error-manage__02-error-architecture__04-error-modal.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 10 |
| [`03-error-manage/02-error-architecture/06-apperror-package`](./03-error-manage__02-error-architecture__06-apperror-package.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 6 |
| [`05-split-db-architecture`](./05-split-db-architecture.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 9 |
| [`06-seedable-config-architecture`](./06-seedable-config-architecture.md) | 90 | 100 | 100 | 100 | 100 | 100 | 100 | **96** | A+ | 10 |
