...
**Mean weighted score:** **79.3/100**  
**Mean implementability:** **56.7/100**
...
| 5 | [`02-coding-guidelines/09-powershell-integration`](./02-coding-guidelines__09-powershell-integration.md) | 68 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 6 | [`02-coding-guidelines/10-research`](./02-coding-guidelines__10-research.md) | 68 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 7 | [`25-app-issues/01-phase-2-git-logs-audit`](./25-app-issues__01-phase-2-git-logs-audit.md) | 68 | 30 | C | 1 TODO/TBD/FIXME marker(s) in module body |
| 8 | [`10-research`](./10-research.md) | 70 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 9 | [`02-coding-guidelines/11-security`](./02-coding-guidelines__11-security.md) | 73 | 30 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 10 | [`14-update/diagrams`](./14-update__diagrams.md) | 70 | 35 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 11 | [`26-gitlogs-diagrams`](./26-gitlogs-diagrams.md) | 71 | 35 | C | 1 broken cross-spec link(s) |
| 12 | [`01-spec-authoring-guide`](./01-spec-authoring-guide.md) | 61 | 40 | C | 11 broken cross-spec link(s) |
| 13 | [`02-coding-guidelines/08-file-folder-naming`](./02-coding-guidelines__08-file-folder-naming.md) | 73 | 40 | C | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
| 14 | [`03-error-manage/03-error-code-registry/09-templates`](./03-error-manage__03-error-code-registry__09-templates.md) | 73 | 40 | C | _no findings_ |
| 15 | [`02-coding-guidelines/07-csharp`](./02-coding-guidelines__07-csharp.md) | 75 | 40 | B | No inlined contract (SQL DDL / JSON schema / TS enum) in module body |
