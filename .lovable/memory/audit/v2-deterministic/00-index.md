...
**Mean implementability:** **81.3/100**
...
|---:|---|---:|:-:|:-:|---|
| 1 | [`03-error-manage/03-error-code-registry`](./03-error-manage__03-error-code-registry.md) | 88 | A | 10 | _none_ |
| 2 | [`03-error-manage/01-error-resolution`](./03-error-manage__01-error-resolution.md) | 91 | A | 10 | _none_ |
| 3 | [`03-error-manage/02-error-architecture`](./03-error-manage__02-error-architecture.md) | 91 | A | 10 | _none_ |
| 4 | [`.`](./..md) | 92 | A | 10 | _none_ |
...
| 15 | [`03-error-manage/02-error-architecture/04-error-modal/01-copy-formats`](./03-error-manage__02-error-architecture__04-error-modal__01-copy-formats.md) | 86 | 75 | A | _no findings_ |
