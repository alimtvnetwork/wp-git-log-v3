...
> Deterministic score 80/100 (B) for spec/06-seedable-config-architecture/02-features.


**Score justification:** Deterministic rubric: contracts=2/3, ac=5, gwt=5, broken_links=1, waffle/kchar=0.13.
