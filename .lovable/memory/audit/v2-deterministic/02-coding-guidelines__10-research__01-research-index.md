# Audit v2 — `spec/02-coding-guidelines/10-research/01-research-index`
...
> Deterministic score 66/100 (C) for spec/02-coding-guidelines/10-research/01-research-index.
