...
> Deterministic score 87/100 (A) for spec/02-coding-guidelines/01-cross-language.


**Score justification:** Deterministic rubric: contracts=3/3, ac=2, gwt=0, broken_links=1, waffle/kchar=0.14.
