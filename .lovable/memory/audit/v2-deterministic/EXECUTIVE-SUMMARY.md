...
See [00-index.md](./00-index.md) for the full per-module ranking + the **QA tooling baseline** footer (Phase 99, expanded Phases 102 + 103 + 104 + 112 + 113 + F2 + H1 + H5 + H7 + 30 + P15 + P47-followup-1) listing the 20 strict CI gates that surround this score.