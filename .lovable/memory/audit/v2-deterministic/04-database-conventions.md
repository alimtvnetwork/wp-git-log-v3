...
> Deterministic score 98/100 (A+) for spec/04-database-conventions.


**Score justification:** Deterministic rubric: contracts=3/3, ac=8, gwt=8, broken_links=0, waffle/kchar=0.15. Gates active: 0.
