...
> Deterministic score 82/100 (B) for spec/03-error-manage/03-error-code-registry.


**Score justification:** Deterministic rubric: contracts=2/3, ac=5, gwt=5, broken_links=1, waffle/kchar=0.05.
