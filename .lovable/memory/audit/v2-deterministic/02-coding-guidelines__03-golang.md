...
> Deterministic score 80/100 (B) for spec/02-coding-guidelines/03-golang.


**Score justification:** Deterministic rubric: contracts=0/3, ac=23, gwt=20, broken_links=0, waffle/kchar=0.34. Gates active: 0.
