...
> Deterministic score 87/100 (A) for spec/03-error-manage/03-error-code-registry/07-schemas.


**Score justification:** Deterministic rubric: contracts=2/3, ac=6, gwt=5, broken_links=0, waffle/kchar=0.13. Gates active: 0.
