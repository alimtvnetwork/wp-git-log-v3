...
> Deterministic score 69/100 (C) for spec/02-coding-guidelines/08-file-folder-naming.


**Score justification:** Deterministic rubric: contracts=0/3, ac=5, gwt=5, broken_links=1, waffle/kchar=0.0. Gates active: 1.
...
- **Evidence:** links_total=26, links_broken=1
