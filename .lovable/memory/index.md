...
- [Phase 20 contract-inlining progress](mem://specs/phase-20-progress) — **COMPLETE: 11 of 11 modules** upgraded. Module #11 (PHP enum spec, `SelfUpdateStatusType`) inlined full backed enum + TS mirror + JSON Schema + forbidden-shapes table on 2026-04-26. Phase 22 baseline (modules 1-9 only): mean weighted 78.3, G-CON-01 firings 23. Awaiting Phase 22 re-run #2 to capture #10+#11 lift.
