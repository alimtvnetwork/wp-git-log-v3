...
This document defines testable acceptance criteria for the **Phase-2 Spec Issues Report — `git-logs` App** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/25-app-issues/01-phase-2-git-logs-audit/`
...
- **Given** the module file `spec/25-app-issues/01-phase-2-git-logs-audit/00-overview.md`
