# Acceptance Criteria — Split DB Architecture — Features Index

**Version:** 1.1.0  
**Updated:** 2026-04-29  
**Scope:** `spec/05-split-db-architecture/02-features/`

---

## Purpose

This document defines testable acceptance criteria for the **Split DB Architecture — Features Index** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/05-split-db-architecture/02-features/`
...
- **Given** the module file `spec/05-split-db-architecture/02-features/00-overview.md`
