---
kind: tracker
description: Issues tracker for Split DB Architecture. Not a contract module — exempt from missing-contract / untestable rubric findings.
---
...
See [`lifecycle-05-split-db-architecture-03-issues-lifecycle.mmd`](./lifecycle-05-split-db-architecture-03-issues-lifecycle.mmd) for the visual lifecycle.
