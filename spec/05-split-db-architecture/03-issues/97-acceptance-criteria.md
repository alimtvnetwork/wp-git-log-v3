# Acceptance Criteria — Split DB Architecture — Issues Index
...
This document defines testable acceptance criteria for the **Split DB Architecture — Issues Index** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/05-split-db-architecture/03-issues/`
...
- **Given** the module file `spec/05-split-db-architecture/03-issues/00-overview.md`
