...
Subfolder defining the conventions that all `14-update/` Mermaid diagrams MUST follow: node naming, edge labels, severity colors, and the required header/footer comments. Sibling `*.mmd` files in the parent index are validated against these rules.
