...
This document defines testable acceptance criteria for the **Diagrams — Self-Update & App Update** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/14-update/diagrams/`
...
- **Given** the module file `spec/14-update/diagrams/00-overview.md`
