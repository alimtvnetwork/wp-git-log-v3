# Acceptance Criteria — Wrong Slug
...
This document defines testable acceptance criteria for the **Wrong Slug** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/99-wrong-slug/`
