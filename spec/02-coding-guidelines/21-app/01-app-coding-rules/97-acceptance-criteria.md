...
### APPCODIN-01: Inlined contract validates  `[critical]`
...
### APPCODIN-02: Schema-required fields enforced  `[critical]`
...
### APPCODIN-03: ID pattern enforced  `[high]`
...
### APPCODIN-06: Cross-references stay valid  `[medium]`
