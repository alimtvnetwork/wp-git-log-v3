...
### AC-APPCODIN-01: Inlined contract validates  `[critical]`
...
### AC-APPCODIN-02: Schema-required fields enforced  `[critical]`
...
### AC-APPCODIN-03: ID pattern enforced  `[high]`
...
### AC-APPCODIN-06: Cross-references stay valid  `[medium]`
