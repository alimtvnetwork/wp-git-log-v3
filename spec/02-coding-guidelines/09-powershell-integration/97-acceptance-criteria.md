...
This document defines testable acceptance criteria for the **PowerShell Integration** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/02-coding-guidelines/09-powershell-integration/`
