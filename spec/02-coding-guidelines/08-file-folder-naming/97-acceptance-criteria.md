# Acceptance Criteria — File & Folder Naming Conventions
...
This document defines testable acceptance criteria for the **File & Folder Naming Conventions** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/02-coding-guidelines/08-file-folder-naming/`
...
- **Given** the module file `spec/02-coding-guidelines/08-file-folder-naming/00-overview.md`
...
- `00-overview.md`
- `01-cross-language.md`
- `02-php-wordpress.md`
- `03-golang.md`
- `04-typescript-javascript.md`
- `05-rust-csharp.md`
