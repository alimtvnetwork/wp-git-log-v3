...
### AC-APPISSUE-01: Inlined contract validates  `[critical]`
...
### AC-APPISSUE-02: Schema-required fields enforced  `[critical]`
...
### AC-APPISSUE-03: ID pattern enforced  `[high]`
...
### AC-APPISSUE-06: Cross-references stay valid  `[medium]`
