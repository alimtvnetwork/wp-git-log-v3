...
### APPISSUE-01: Inlined contract validates  `[critical]`
...
### APPISSUE-02: Schema-required fields enforced  `[critical]`
...
### APPISSUE-03: ID pattern enforced  `[high]`
...
### APPISSUE-06: Cross-references stay valid  `[medium]`
