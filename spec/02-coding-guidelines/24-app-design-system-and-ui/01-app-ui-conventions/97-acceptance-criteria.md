...
### AC-APPUICON-01: Inlined contract validates  `[critical]`
...
### AC-APPUICON-02: Schema-required fields enforced  `[critical]`
...
### AC-APPUICON-03: ID pattern enforced  `[high]`
...
### AC-APPUICON-06: Cross-references stay valid  `[medium]`
