...
This document defines testable acceptance criteria for the **Axios Version Control Policy** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/02-coding-guidelines/11-security/01-axios-version-control/`
...
- **Given** the module file `spec/02-coding-guidelines/11-security/01-axios-version-control/00-overview.md`
