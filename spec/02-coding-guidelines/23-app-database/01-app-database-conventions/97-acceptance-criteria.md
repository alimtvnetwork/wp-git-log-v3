...
### APPDATAB-01: Inlined contract validates  `[critical]`
...
### APPDATAB-02: Schema-required fields enforced  `[critical]`
...
### APPDATAB-03: ID pattern enforced  `[high]`
...
### APPDATAB-06: Cross-references stay valid  `[medium]`
