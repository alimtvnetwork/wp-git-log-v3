...
### AC-APPDATAB-01: Inlined contract validates  `[critical]`
...
### AC-APPDATAB-02: Schema-required fields enforced  `[critical]`
...
### AC-APPDATAB-03: ID pattern enforced  `[high]`
...
### AC-APPDATAB-06: Cross-references stay valid  `[medium]`
