...
**Version:** 3.3.4
**Updated:** 2026-05-01 (Phase 153 Task A24-fu34 — axis reclassification audit-corpus → normative-contract per Lesson #69; spec/26 §97 contains 22+ GWT-style normative ACs (AC-DG-01..22+) defining diagram invariants implementer authors MUST satisfy. Sibling spec/03 same pattern lifted 82 → 94 EXCELLENT in fu33. v9 cache d2=20+d3=17 axis-capped at 95 under audit-corpus ×0.5 multipliers; expected post-fix 92-94 EXCELLENT. Tree-wide axis audit complete: spec/10/25 retain audit-corpus (correct per Lesson #29); spec/26 fixed here; 0 additional misclassifications. Lockstep §00 3.4.3→3.4.4, §98 3.4.3→3.4.4, §99 3.3.3→3.3.4; §97 unchanged at v3.3.0.)
