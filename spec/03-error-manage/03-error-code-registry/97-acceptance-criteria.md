# Acceptance Criteria — Error Code Registry
...
This document defines testable acceptance criteria for the **Error Code Registry** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/03-error-manage/03-error-code-registry/`
...
- **Given** the module file `spec/03-error-manage/03-error-code-registry/00-overview.md`
