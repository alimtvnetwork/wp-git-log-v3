# Acceptance Criteria — Error Modal — Copy & Export Formats (Index)
...
This document defines testable acceptance criteria for the **Error Modal — Copy & Export Formats (Index)** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/03-error-manage/02-error-architecture/04-error-modal/01-copy-formats/`
...
- **Given** the module file `spec/03-error-manage/02-error-architecture/04-error-modal/01-copy-formats/00-overview.md`
...
- `00-overview.md`
- `01-compact-report.md`
- `02-full-report.md`
- `03-full-report-with-backend-logs.md`
- `04-error-log-txt.md`
- `05-full-log-txt.md`
- `06-error-log-with-delegated-info.md`
- `07-envelope-error-response.md`
- `08-session-diagnostics.md`
- `09-generator-code-reference.md`
- `98-changelog.md`
