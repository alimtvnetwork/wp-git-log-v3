...
This document defines testable acceptance criteria for the **Error Modal — Reusable React Components (Index)** module. Every criterion is verifiable from the module's content alone — an AI implementer or human reviewer can check pass/fail without external context.
...
- **Given** the module folder `spec/03-error-manage/02-error-architecture/04-error-modal/02-react-components/`
...
- **Given** the module file `spec/03-error-manage/02-error-architecture/04-error-modal/02-react-components/00-overview.md`
...
- `03-api-types.md`
- `04-hooks.md`
- `05-component-hierarchy.md`
- `06-component-source.md`
