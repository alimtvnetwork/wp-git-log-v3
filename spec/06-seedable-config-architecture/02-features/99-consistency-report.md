...
| 06 | `06-update-check-keys.md` | ✅ Present |
...
> Run `python3 linter-scripts/check-spec-cross-links.py --root spec/06-seedable-config-architecture/02-features` to verify.
